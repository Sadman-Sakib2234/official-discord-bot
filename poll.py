            ...
            with open('poll.json', 'r') as poll_file:
                ...
                if str(payload.message_id) in poll_data:
                    ...
                    if payload.emoji.name == '1⃣' and list(poll_data[str(payload.message_id)][0].values())[
                            0] < max_vote_count:
                        first_poll = list(
                            poll_data[str(payload.message_id)][0].keys())[0]
                        ...
                        await reaction.remove(payload.member)
                            ...
                            1] < max_vote_count:
                        second_poll = list(
                            poll_data[str(payload.message_id)][0].keys())[1]
                        ...
                        await reaction.remove(payload.member)
                            ...
                            2] < max_vote_count:
                        third_poll = list(
                            poll_data[str(payload.message_id)][0].keys())[2]
                        ...
                        await reaction.remove(payload.member)
                            ...
                            3] < max_vote_count:
                        fourth_poll = list(
                            poll_data[str(payload.message_id)][0].keys())[3]
                        ...
                        await reaction.remove(payload.member)
                            ...
                            4] < max_vote_count:
                        fifth_poll = list(
                            poll_data[str(payload.message_id)][0].keys())[4]
                        ...
                        await reaction.remove(payload.member)
                            ...
                            5] < max_vote_count:
                        sixth_poll = list(
                            poll_data[str(payload.message_id)][0].keys())[5]
                        ...
                        await reaction.remove(payload.member)
                            ...
                            6] < max_vote_count:
                        seventh_poll = list(
                            poll_data[str(payload.message_id)][0].keys())[6]
                        poll_data[str(payload.message_id)
                                  ][0][seventh_poll] += 1
                        ...
                        await reaction.remove(payload.member)
                            ...
                            7] < max_vote_count:
                        eighth_poll = list(
                            poll_data[str(payload.message_id)][0].keys())[7]
                        ...
                        await reaction.remove(payload.member)
                            ...
                            8] < max_vote_count:
                        ninth_poll = list(
                            poll_data[str(payload.message_id)][0].keys())[8]
                        ...
                        await reaction.remove(payload.member)
                            ...
                            9] < max_vote_count:
                        tenth_poll = list(
                            poll_data[str(payload.message_id)][0].keys())[9]
                    ...
                    # Update embed
                    options = list(
                        poll_data[str(payload.message_id)][0].keys())
        ...
        with open('scheduler.json', 'r') as schedule_file:
            ...
            for item in scheduler_data.items():
                ...
                prev_time = datetime.strptime(
                    item[1]['poll_start_time'].replace('T', ' '), '%Y-%m-%d %H:%M:%S.%f')
                ...
                poll_outcome = max(
                    poll_data[str(message.id)][0].items(), key=lambda i: i[1])
                ...
                if int(calc_minutes) > item[1]['scheduler_time'] or poll_outcome[1] >= item[1]['max_vote']:
                    if str(message.id) in poll_data:
                        ...
                        with open('scheduler.json', 'w') as update_scheduler_data:
                            json.dump(scheduler_data,
                                      update_scheduler_data, indent=4)
